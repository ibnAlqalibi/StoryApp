...
import com.ibnalqalibi.storyapp.DataDummy
import com.ibnalqalibi.storyapp.MainDispatcherRule
...
import com.ibnalqalibi.storyapp.getOrAwaitValue
...
class StoriesViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val storiesViewModel = StoriesViewModel(userRepository)
        val actualStory: PagingData<ListStoryItem> = storiesViewModel.stories.getOrAwaitValue()
